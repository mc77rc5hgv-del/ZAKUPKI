...
/watcharea район — новые закупки по району
...
Формат фильтра: ключи=ноутбук, компьютер; исключить=ремонт; минцена=100000; максцена=3000000; заказчик=администрация; регион=Краснодарский край; район=Каневской район, Динской район; окпд=26.20; дней=3-20; документы=да; сорт=срок`;
...
export const botCommands = [
  ...
  { command: "watcharea", description: "Мониторинг по районам" },
